 ...
 *   }
 *
 * - `config` is the vendor's own config sub-object from the plugin config.
 * - `helpers` carries { postJson, envValue, readHomeJson, firstNonBlank,
 *   cleanSnippet, positiveInteger, errors } so vendor modules stay free of
 *   harness imports and share one transport/errors implementation.
